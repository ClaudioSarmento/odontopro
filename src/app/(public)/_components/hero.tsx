                ...
                <main className="flex items-center justify-center">
                    <article className="max-w-3xl space-y-8 flex flex-col justify-center">
                        <h1 className="text-4xl lg:text-5xl font-bold max-w-2xl tracking-tight">
                            ...
                            profissionais em um único local!
                        </h1>
                        <p className="text-base md:text-lg text-gray-600">
                            Nós somos uma plataforma para profssionais de
                            saúde com foco em agilizar seu atendimento de
                            forma simplicada e organizada.
                        </p>
